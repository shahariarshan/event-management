...
const Footer = () => {
    return (
        <footer className="footer p-10 bg-stone-950 text-base-content">
  <nav>
    <header className="footer-title text-white">Services</header> 
    <a className="link link-hover  text-white">Yoga</a> 
    <a className="link link-hover  text-white">Fitness</a> 
    <a className="link link-hover  text-white">Wellness</a> 
    <a className="link link-hover  text-white">Meditation</a>
  </nav> 
  <nav>
